...
<div class="container">
    ...
    <form id="video-importer" action="<?= admin_url( '/admin-ajax.php' ) ?>">
        <label class="embed-url">
            <input id="embed-url" class="url" name="url" type="url" placeholder="<?php _e( 'Paste video link here', 'post-gallery' ) ?>">
            <i class="loader fa fa-spinner fa-spin" style="display:none"></i>
            <p class="description">
                <?php _e( 'Supported:', 'post-gallery' ) ?>
        ...
        <div class="actions" style="display: none">
            <button type="submit" name="import" class="import button button-primary">
                <?= apply_filters( 'post_gallery_video_importer_button_label', __( 'Import', 'post-gallery' ) ) ?>
            </button>
        </div>
