...
1. Download the chordwp.zip file
...
To Uninstall ChordWP

1. Deactivate ChordWP thorugh the 'Plugins' menu in WordPress
2. Click the "delete" link to delete the ChordWP plugin. This will remove all
of the ChordWP files from your plugins directory. It will not delete any posts
...
1. Creating a Sheet Music post
2. Using the [chordwp] shortcode
...
= 1.0 =
Initial realeae of ChordWP - Sheet Music For WordPress
